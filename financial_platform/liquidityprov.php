...
<body class="mobile">
    ...
    <main>
        <section class="header container links">
            <div>
                <div><img src="images/bank-campus-court-svgrepo-com.svg" style="width: 100px; margin-bottom: 20px;";></div>
                <h1>Liquidity Providers</h1>
                <h4>Company offers access to Deep Liquidity via our commercial-level liquidity bridge connected to <strong>Tier 1</strong> regulated liquidity providers and equipped with an innovative quote aggregator that matches trader's order with the best quote available.
                    Our liquidity providers are major banks, hedge funds, financial institutions and prime brokers.</h4><h4>Trading process via <strong>STP (Straight Through Processing)</strong> technology implies that all orders of our clients are automatically transferred to liquidity providers without any interference on the part of the broker. It helps traders and the company to avoid any conflicts of interest. In this case, the profit clients receive doesn’t yield any losses to the broker.
                    Thanks to our cooperation with the leading providers, we can offer our clients a high level of the liquidity, which provides fast and secure execution of all orders, even if their volume is very high.</h4>
            </div>
        </section>
        <section class="header container links" id="providers_header">
        ...
        <section class="header container links" id="providers_header">
            <div class="container" id="container_providers1">
                <div class="row padding-bottom-10">
                </div>
                <div class="providers-main">
                    <div class="providers">
                        <img loading="lazy" src="Images/commerz.png"></img>
                    </div>
                    <div class="providers">
                        <img loading="lazy" src="Images/hsbc.png"></img>
                    </div>
                    <div class="providers">
                        <img loading="lazy" src="Images/barclays2.png"> </img>
                    </div>
                    <div class="providers">
                        <img loading="lazy" src="Images/bnp.png">
                    </div>
                    <div class="providers">
                        <img loading="lazy" src="Images/boa2.png"></img>
                    </div>
                </div>
                        </div>
        </section>

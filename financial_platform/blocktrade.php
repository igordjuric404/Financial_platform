...
<body class="mobile">
    ...
    <main>
        <div class="pics-img">
            <div class="test-head">
                <h1 style="font-weight: 500;">Block Trading Desk</h1>
                <h4>Have your large-volume trades handled by experts.</h4>
            </div>
            <img src="Images/blockimg3.jpeg" id="cover-img">
        </div>
        <section class="header container" id="block-trade">
            <div>
                <h1>We give you edge over the market</h1>
                <p><i class="ri-check-double-line"></i>Exclusive service for large trades - stocks over 10K shares, options over 100 contracts,<br>bonds over USD 100k par - from our brokers with over 30 years of experience</p>
                <p><i class="ri-check-double-line"></i>Start-to-finish execution and monitoring of large trades</p>
                <p><i class="ri-check-double-line"></i>Access to liquidity not available electronically, via relationships with "upstairs" providers</p>
                <p><i class="ri-check-double-line"></i>Reduce fees to minimum </p>
            </div>
        </section>
        <section class="header container" id="block-desk">
            <div class="container" id="container-laptop">
                <div class="row justify-content-center">
                    <div class="platform-text">
                        <h2 class="mb-3">About<span class="ai-powered"> Block Trading Desk</span></h2>
                            <div class="filler">
                                <p>Every trading desk is managed by professional traders who align their approach with your needs,<br>tailor-make alternatives and use decades of high-volume trading experience to give you best solutions.</p>
                                </div>
                            <div class="filler">
                                <p>Our order desk will attempt to find price improvement or additional liquidity for large trades, compared to other alternative execution methods.</p>
                            </div>
                            <div class="filler">
                                <p><i class="ri-arrow-right-s-fill"></i>Minimums are 10K shares and 100 option contracts</p>
                            </div>
                            <div class="filler">
                                <p><i class="ri-arrow-right-s-fill"></i>Minimum size for a corporate bond trade is USD 100K par</p>
                            </div>
                            <div class="filler">
                                <p><i class="ri-arrow-right-s-fill"></i>Commissions of $0.01 per share of stock and $0.80 per option contract, 1BPS of face value</p>
                            </div>
                    </div>
                </div>
            </div>

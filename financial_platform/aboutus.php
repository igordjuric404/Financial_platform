...
<body class="mobile">
    ...
    <main>
        <div class="pics-img">
            <div class="test-head">
                <h1 style="font-weight: 500;">About Us. Why to choose the best?</h1>
                <h4>We are a world-leading online trading provider, giving you access to opportunities across thousands of financial markets.</h4>
            </div>
            <img src="Images/aboutus.webp" id="cover-img">
        </div>
        <section class="header container about-us">
            <div class="container" id="container-vault1">
                <div class="this align-items-center" id="about-confidence">
                    <div class="confidence-text">
                        ...
                        <div class="totals-about">
                            <div class="boxes">
                                <div class="small-box">
                                    <p class="top-info">Powerful Platform  <i class="ri-check-line"></i></p>
                                    <p class="bottom-info">Seize opportunities in seconds on fast and reliable platform. More than 100 global markets available in your pocket.</p>
                                </div>
                                <div class="small-box">
                                    <p class="top-info">Personal Advisors  <i class="ri-check-line"></i></p>
                                    <p class="bottom-info">Company's most important assets are our qualified advisors. They'll be with you on your trading journey and assist you with making profitable decisions. </p>
                                </div>
                                <div class="small-box">
                                    <p class="top-info">Premium Trading Events  <i class="ri-check-line"></i></p>
                                    <p class="bottom-info">IPOs, ICOs, Knock-Outs, Out-of-hours trading.<br>We have it all. Don't limit your potential.</p>
                                </div>
                                <div class="small-box">
                                    <p class="top-info">Risk Management  <i class="ri-check-line"></i></p>
                                    <p class="bottom-info">AI systems are integrated into crucial part of investing: assesing and managing risk.<br>Minimize risks. Maximize profits.</p>
                                </div>
                                <div class="small-box">
                                    <p class="top-info">Low Commissions  <i class="ri-check-line"></i></p>
                                    <p class="bottom-info">Trade regularly? Get even lower fees through<br>our volume based account type rebates.</p>
                                </div>
                                <div class="small-box">
                                    <p class="top-info">Your Money is Protected  <i class="ri-check-line"></i></p>
                                    <p class="bottom-info">Your funds are held in segregated accounts at regulated banks. We don't use your money for our business activity. You are entitled to compensation schemes.</p>
                                </div>
                            </div>
                        </div>
            </div>
        </section>
        <section class="header container laptop-about">

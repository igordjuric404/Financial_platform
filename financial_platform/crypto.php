    ...
    <main>
        ...
        <section class="header container" id="main-link">
            <div>
                ...
                <h4>Take your position on popular cryptocurrency markets with CFDs. Leverege and maximize uprecedented market movements.</h4>
            </div>
        </section>
        </div>
        <section class="header container links">
            <div>
                ...
                <h4>A cryptocurrency is a digital or virtual currency secured by cryptography, which makes it nearly impossible to counterfeit or double-spend. Most cryptocurrencies exist on decentralized networks using blockchain technology—a distributed ledger enforced by a disparate network of computers.</h4>
            </div>
            <div class="totals" id="totals-trading">
                <div class="boxes" id="boxes-trading">
                    <div class="small-box">
                        <p1>What are Cryptocurrencies</p1>
                        <p>Cryptocurrencies are digital, decentralized currencies that were created to work as a medium of exchange. The cryptocurrency market offers traders a new way of investing; free from intermediaries such as governments or rating agencies. Hence, price movements on cryptos is driven by a multitude of factors such as market demand and relative news.Cryptocurrencies are digital, decentralized currencies that were created to work as a medium of exchange. The cryptocurrency market offers traders a new way of investing; free from intermediaries such as governments or rating agencies. Hence, price movements on cryptos is driven by a multitude of factors such as market demand and relative news.</p>
                            <p>When you trade cryptocurrencies on CFDs, you're speculating on whether the price will rise or fall and you don't own any underlying coins.</p>                         
                    </div>
                    <div class="small-box">
                        <p1><i class="ri-btc-fill" style="color: #f7931a; font-size: 50px;margin-right: 10px; vertical-align: middle;"></i>  Bitcoin</p1>
                          ...
                          <p1>What makes Bitcoin unique?</p1>
                          ...
                          <p>The entire cryptocurrency market — now worth more than $2 trillion — is based on the idea realized by Bitcoin: money that can be sent and received by anyone, anywhere in the world without reliance on trusted intermediaries, such as banks and financial services companies.</p>
                          <p style="font-weight: bold; font-size: 20px;">How much Bitcoin is in Circulation?</p>
                          ...
                          <p>As compensation for spending their computational resources, the miners receive rewards for every block that they successfully add to the blockchain. At the moment of Bitcoin's launch, the reward was 50 bitcoins per block: this number gets halved with every 210,000 new blocks mined — which takes the network roughly four years.</p>
                          <p style="font-weight: bold; font-size: 20px;">Who are Largest Corporate holders of Bitcoin?</p>
                          <p>A few years ago, the idea that a publicly traded company might hold Bitcoin on its balance sheets seemed highly laughable. The flagship cryptocurrency was considered to be too volatile to be adopted by any serious business. Many top investors, including Warren Buffett, labeled the asset a “bubble waiting to pop.”</p>
                          <p>This negative sentiment appears to have been broken, with a number of corporate behemoths buying up Bitcoin since 2020. In particular, business intelligence firm MicroStrategy set the pace after it bought $425 million worth of Bitcoin in August and September 2020. Since then, many others have followed suit, including EV manufacturer Tesla.</p>
                          <p><strong>MicroStrategy</strong> has by far the largest Bitcoin portfolio held by any publicly-traded company. The business analytics platform has adopted Bitcoin as its primary reserve asset, aggressively buying the cryptocurrency, with 174K Bitcoins worth approximately <strong>$12.5 Billion.</strong></p>
                          <p>Other top corporate holders include Galaxy with 17,518 BTC, Marathon Digital Holdings, (13,716), Tesla (10,500), Hut 8 Mining Corp. (9,366), Coinbase (9,181), Square Inc. (8,027).</p>
                        </div>
                <div class="small-box">
                    <p1><i class="ri-eth-fill" style="color: #647cf6; font-size: 50px;margin-right: 10px; vertical-align: middle;"></i>  Ethereum</p1>
                      ...
                      <p>Ethereum was first described in a 2013 whitepaper by Vitalik Buterin. Buterin, along with other co-founders, secured funding for the project in an online public crowd sale in the summer of 2014. The project team managed to raise $18.3 million in Bitcoin, and Ethereum's price in the Initial Coin Offering (ICO) was $0.311, with over 60 million Ether sold.</p>
                      <p>The Ethereum Foundation officially launched the blockchain on July 30, 2015, under the prototype codenamed “Frontier.” Since then, there has been several network updates — “Constantinople” on Feb. 28, 2019, “Istanbul” on Dec. 8, 2019, “Muir Glacier” on Jan. 2, 2020, “Berlin” on April 14, 2021, and most recently on Aug. 5, 2021, the “London” hard fork.</p>
                     <p>Ethereum's own purported goal is to become a global platform for decentralized applications, allowing users from all over the world to write and run software that is resistant to censorship, downtime and fraud.</p>
                     <p style="font-weight: bold; font-size: 20px;">What makes Ethereum unique?</p>
                      <p>Ethereum has pioneered the concept of a blockchain smart contract platform. Smart contracts are computer programs that automatically execute the actions necessary to fulfill an agreement between several parties on the internet. They were designed to reduce the need for trusted intermediates between contractors, thus reducing transaction costs while also increasing transaction reliability.</p>
                      ...
                      <p>In addition to smart contracts, Ethereum's blockchain is able to host other cryptocurrencies, called “tokens,” through the use of its ERC-20 compatibility standard. In fact, this has been the most common use for the ETH platform so far: to date, more than 280,000 ERC-20-compliant tokens have been launched. Over 40 of these make the top-100 cryptocurrencies by market capitalization, for example, USDT, LINK and BNB. </p>
                    </div>
            <div class="small-box">
                <p1><i class="ri-xrp-fill" style="color: #697d8b; font-size: 50px;margin-right: 10px; vertical-align: middle;"></i>  Altcoins</p1>
                  <p>Altcoin refers to any alternative cryptocurrency to Bitcoin and Ethereum</p>
                  <p>"Altcoin" is a combination of the two words "alternative" and "coin." Altcoins attempt to improve upon the perceived limitations of whichever cryptocurrency and blockchain they are forked from or competing with. The first altcoin was Litecoin, forked from the Bitcoin blockchain in 2011.</p>
                 <p>Altcoins, especially new project not previously available to the market, going public via ICO (Initial Coin Offering) have potenital of performing very well, with <strong>ROI of 1,000% +</strong></p>
                  <p>On our platform you can trade wide range of Altcoins like Doge, Solana, Polkadot, Chainlink and many more with tight spreads and appropriate leverage!</p>
                </div>
                </div>
        </div>
            </div>
